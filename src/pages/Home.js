...
function Home() {
  ...
  useEffect(() => {
    window.scrollTo(0, 0);
    document.title = "Salta Birjar - home";
        ...
        <Row className="d-flex justify-content-center text-center mb-4">
          <Col md={6}>
            <div className="section_title ">
              ...
              <h2 className="display-6 text-capitalize fw-bold">
                Food with a special taste
              </h2>
            </div>
          </Col>
        </Row>
        ...
        <Row className="g-4">
          ...
          <Col md={6} className="pt-5">
            ...
            <p className="text-2">
              ...
              delectus quas praesentium impedit, quos et consequuntur dolores
              nemo dolor repellat
            </p>
        ...
        <Row className="d-flex justify-content-center text-center mb-4">
          <Col md={6}>
            <h2 className="fw-bold text-capitalize">
              popular dishes with. dilivery
            </h2>
            <p>
              Lorem ipsum dolor sit amet consectetur adipisicing elit. Harum
              excepturi eligendi voluptatibus, expedita quibusdam officia
              placeat dolorem alias quam
            </p>
          </Col>
        </Row>
        ...
        <Container>
          <Row>
            ...
            <Col md={6} className="mt-5 ps-5 pb-5">
              <h2 className="display-5 fw-bold text-capitalize">
                download app now
              </h2>
              <p>
                Lorem ipsum dolor sit amet consectetur adipisicing elit.
                Explicabo qui in recusandae commodi nostrum necessitatibus cum?
              </p>
        ...
        <Row className="d-flex justify-content-center text-center mb-4">
          <Col md={6}>
            <div className="section_title ">
              ...
              <h2 className="display-6 text-capitalize fw-bold">
                Customer opinions about our services
              </h2>
            </div>
          </Col>
        </Row>
