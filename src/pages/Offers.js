...
function Offers() {
  ...
  useEffect(() => {
    window.scrollTo(0, 0);
    document.title = "Salta Birjar - offers";
  ...
  return (
    <>
      ...
      <section
        ...
        style={{
          backgroundImage: 'url("/images/background/background-offer.jpg")',
        }}
      >
      ...
      <Container className="py-5">
        <Row className="g-4">
          <Col md={6}>
            <Image className="w-100" src="/images/fast-food-2.svg" />
          </Col>
          <Col md={6} className="pt-5">
            <h1 className="display-5 mt-4 fw-bold">
