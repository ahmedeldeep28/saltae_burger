...
function Menu() {
  ...
  useEffect(() => {
    window.scrollTo(0, 0);
    document.title = "Salta Birjar - menu";
  ...
  let backgroundPage = () => {
    if (!foodName) {
      ...
      return "/images/background/background-pizza.jpg";
    } else if (foodName === "burger") {
      return "/images/background/background-burger.jpg";
    } else if (foodName === "drinks") {
      return "/images/background/background-drinks.jpg";
    } else if (foodName === "dessert") {
      return "/images/background/background-dessert.jpg";
    } else if (foodName === "pasta") {
      return "/images/background/background-pasta.jpg";
    }
  };
        ...
        <div className="card p-4 shadow-sm rounded-5 mb-5 ">
          ...
          <Row className="g-3">
            <Col md={9}>
              <InputGroup>
                <InputGroup.Text
                  className="bg-primary border-primary text-white border-right-0"
                  id="basic-addon1"
                >
                  <MdOutlineSearch className="fs-2" />
                </InputGroup.Text>
                <Form.Control
            ...
            <Col md={3}>
              <Dropdown>
                ...
                <Dropdown.Menu>
                  ...
                  <Dropdown.Item as={Link} to="/menu/burger">
                    burger
                  </Dropdown.Item>
                  <Dropdown.Item as={Link} to="/menu/pizza">
                    pizza
                  </Dropdown.Item>
                  <Dropdown.Item as={Link} to="/menu/drinks">
                    drinks
                  </Dropdown.Item>
                  <Dropdown.Item as={Link} to="/menu/dessert">
                    dessert
                  </Dropdown.Item>
                  <Dropdown.Item as={Link} to="/menu/pasta">
                    pasta
                  </Dropdown.Item>
                </Dropdown.Menu>
              </Dropdown>
