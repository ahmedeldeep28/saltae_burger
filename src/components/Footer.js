        ...
        <Row>
          ...
          <Col sm={6} md={2}>
            <ul className="list-unstyled">
              ...
              <li className="mb-2 text-capitalize">
                <Link to="/about" className="text-dark d-block">
                  about
                </Link>
              </li>
              <li className="mb-2 text-capitalize">
                <Link to="/menu" className="text-dark d-block">
                  menu
                </Link>
              </li>
              <li className="mb-2 text-capitalize">
                <Link to="/offer" className="text-dark d-block">
                  offer
                </Link>
              </li>
              <li className="mb-2 text-capitalize">
                <Link to="/contact" className="text-dark d-block">
                  contact
                </Link>
              </li>
            </ul>
          ...
          <Col sm={6} md={2}>
            <ul className="list-unstyled">
              ...
              <li className="mb-2 text-capitalize">
                <Link to="/menu/burger" className="text-dark d-block">
                  burger
                </Link>
              </li>
              <li className="mb-2 text-capitalize">
              ...
              <li className="mb-2 text-capitalize">
                <Link to="/menu/pizza" className="text-dark d-block">
                  pizza
                </Link>
              </li>
              <li className="mb-2 text-capitalize">
                <Link to="/menu/drinks" className="text-dark d-block">
                  drinks
                </Link>
              </li>
              <li className="mb-2 text-capitalize">
                <Link to="/menu/dessert" className="text-dark d-block">
                  dessert
                </Link>
              </li>
              <li className="mb-2 text-capitalize">
                <Link to="/menu/pasta" className="text-dark d-block">
                  pasta
                </Link>
              </li>
            </ul>
