  ...
  return (
    <>
      ...
      <Navbar bg="white" className="shadow-sm" fixed="top" expand="md">
        <Container>
          <Navbar.Brand className="text-capitalize" as={Link} to="">
            Salta birjar
          </Navbar.Brand>
          <div className="d-block ms-auto me-2 d-md-none">
            {!isUser ? (
              <>
                ...
                <Button className="ms-1" onClick={handleShowSinup}>
                  sinup
                </Button>
              </>
            ) : (
              <Link to="/cart" className="me-3 position-relative">
                ...
                <Badge
                  bg="danger"
                  className="position-absolute top-0 end-50 translate-middle"
                >
                  {sizeCart}
                </Badge>
              </Link>
          ...
          <Navbar.Collapse>
            <Nav className="m-auto">
              <Nav.Link className="text-capitalize" as={NavLink} to="/">
                home
              </Nav.Link>
              <Nav.Link className="text-capitalize" as={NavLink} to="/about">
                about
              </Nav.Link>
              <Nav.Link className="text-capitalize" as={NavLink} to="/menu">
                menu
              </Nav.Link>
              <Nav.Link className="text-capitalize" as={NavLink} to="/offer">
                offers
              </Nav.Link>
              <Nav.Link className="text-capitalize" as={NavLink} to="/contact">
                contact
              </Nav.Link>
              {isUser ? (
                <Button
                  variant="danger"
                  className="mt-1 d-block d-md-none"
